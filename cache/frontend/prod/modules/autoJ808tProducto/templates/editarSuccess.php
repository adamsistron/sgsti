...
Ext.ns("J808tProductoEditar");
J808tProductoEditar.main = {
init:function(){
...
this.guardar = new Ext.Button({
    ...
    handler:function(){
        ...
        if(!J808tProductoEditar.main.formPanel_.getForm().isValid()){
            Ext.Msg.alert("Alerta","Debe ingresar los campos en rojo");
            return false;
        }
        J808tProductoEditar.main.formPanel_.getForm().submit({
            method:'POST',
            url:'/sgsti/web/index.php/J808tProducto/guardar',
            ...
            success: function(form, action) {
			 ...
			 animEl: document.body,
                 ...
                 J808tProductoEditar.main.winformPanel_.hide();
             }
        });
...
//    iconCls: 'icon-cancelar',
    handler:function(){
        J808tProductoEditar.main.winformPanel_.close();
    }
});
...
this.winformPanel_ = new Ext.Window({
    title:'Formulario: J808tProducto',
    modal:true,
    constrain:true,
width:400,
    frame:true,
...
Ext.onReady(J808tProductoEditar.main.init, J808tProductoEditar.main);
</script>
