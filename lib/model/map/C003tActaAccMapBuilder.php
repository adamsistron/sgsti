...
/**
 * This class adds structure of 'c003t_acta_acc' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class C003tActaAccMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.C003tActaAccMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(C003tActaAccPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(C003tActaAccPeer::TABLE_NAME);
		$tMap->setPhpName('C003tActaAcc');
		$tMap->setClassname('C003tActaAcc');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('c003t_acta_acc_co_acc_seq');
		...
		$tMap->addForeignKey('CO_ESTADO_ACTA', 'CoEstadoActa', 'BIGINT', 'j005t_estado_acta', 'CO_ESTADO_ACTA', true, null);

		$tMap->addColumn('FE_DESTRUYE', 'FeDestruye', 'DATE', false, null);

		$tMap->addForeignKey('CO_DESTRUYE', 'CoDestruye', 'BIGINT', 'j811t_usuario', 'CO_USUARIO', false, null);
		...
		$tMap->addColumn('CO_ELABORA', 'CoElabora', 'BIGINT', true, null);

		$tMap->addForeignKey('CO_CUSTODIO', 'CoCustodio', 'BIGINT', 'j812_persona', 'CO_PERSONA', true, null);

		$tMap->addForeignKey('CO_TIPO_RECURSO', 'CoTipoRecurso', 'BIGINT', 'j805t_tipo_recurso', 'CO_TIPO_RECURSO', true, null);
