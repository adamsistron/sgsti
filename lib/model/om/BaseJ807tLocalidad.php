...
/**
 * Base class that represents a row from the 'j807t_localidad' table.
 *
 * 
 *
 ...
 */
abstract class BaseJ807tLocalidad extends BaseObject  implements Persistent {


  const PEER = 'J807tLocalidadPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        J807tLocalidadPeer
	 */
	...
	/**
	 * Initializes internal state of BaseJ807tLocalidad object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     J807tLocalidad The current object (for fluent API support)
	 */
	public function setCoLocalidad($v)
	{
		...
		if ($this->co_localidad !== $v) {
			$this->co_localidad = $v;
			$this->modifiedColumns[] = J807tLocalidadPeer::CO_LOCALIDAD;
		}
	...
	public function setTxDescripcion($v)
	{
		...
		if ($this->tx_descripcion !== $v) {
			...
			$this->modifiedColumns[] = J807tLocalidadPeer::TX_DESCRIPCION;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = J807tLocalidadPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = J807tLocalidadPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCoTransaccion($v)
	{
		...
		if ($this->co_transaccion !== $v) {
			...
			$this->modifiedColumns[] = J807tLocalidadPeer::CO_TRANSACCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_localidad = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			...
			return $startcol + 5; // 5 = J807tLocalidadPeer::NUM_COLUMNS - J807tLocalidadPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating J807tLocalidad object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = J807tLocalidadPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseJ807tLocalidad:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			J807tLocalidadPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseJ807tLocalidad:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseJ807tLocalidad:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(J807tLocalidadPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(J807tLocalidadPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseJ807tLocalidad:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			J807tLocalidadPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = J807tLocalidadPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setCoLocalidad($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += J807tLocalidadPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = J807tLocalidadPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = J807tLocalidadPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = J807tLocalidadPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getCoLocalidad(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setCoLocalidad($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(J807tLocalidadPeer::CO_LOCALIDAD)) $criteria->add(J807tLocalidadPeer::CO_LOCALIDAD, $this->co_localidad);
		if ($this->isColumnModified(J807tLocalidadPeer::TX_DESCRIPCION)) $criteria->add(J807tLocalidadPeer::TX_DESCRIPCION, $this->tx_descripcion);
		if ($this->isColumnModified(J807tLocalidadPeer::CREATED_AT)) $criteria->add(J807tLocalidadPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(J807tLocalidadPeer::UPDATED_AT)) $criteria->add(J807tLocalidadPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(J807tLocalidadPeer::CO_TRANSACCION)) $criteria->add(J807tLocalidadPeer::CO_TRANSACCION, $this->co_transaccion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(J807tLocalidadPeer::CO_LOCALIDAD, $this->co_localidad);
	...
	/**
	 * Generic method to set the primary key (co_localidad column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of J807tLocalidad (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCoLocalidad(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     J807tLocalidad Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     J807tLocalidadPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new J807tLocalidadPeer();
		}
		return self::$peer;
	}
	...
	public function getC801tTransaccion(PropelPDO $con = null)
	{
		if ($this->aC801tTransaccion === null && (($this->co_transaccion !== "" && $this->co_transaccion !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aC801tTransaccion->addJ807tLocalidads($this);
			 */
		}
	 ...
	 * Otherwise if this J807tLocalidad has previously been saved, it will retrieve
	 * related J006tLugarSeguros from storage. If this J807tLocalidad is new, it will return
		...
		if ($this->collJ006tLugarSeguros === null) {
			if ($this->isNew()) {
			   $this->collJ006tLugarSeguros = array();
				...
				$criteria->add(J006tLugarSeguroPeer::CO_LOCALIDAD, $this->co_localidad);
	 ...
	 * Otherwise if this J807tLocalidad is new, it will return
	 * an empty collection; or if this J807tLocalidad has previously
	 * been saved, it will retrieve related J006tLugarSeguros from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in J807tLocalidad.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseJ807tLocalidad:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseJ807tLocalidad::%s', $method));
    }
