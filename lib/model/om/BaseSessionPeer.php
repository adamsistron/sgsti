...
abstract class BaseSessionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Session';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('SessId', 'SessData', 'SessTime', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sessId', 'sessData', 'sessTime', ),
		BasePeer::TYPE_COLNAME => array (self::SESS_ID, self::SESS_DATA, self::SESS_TIME, ),
		BasePeer::TYPE_FIELDNAME => array ('sess_id', 'sess_data', 'sess_time', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('SessId' => 0, 'SessData' => 1, 'SessTime' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sessId' => 0, 'sessData' => 1, 'sessTime' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::SESS_ID => 0, self::SESS_DATA => 1, self::SESS_TIME => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('sess_id' => 0, 'sess_data' => 1, 'sess_time' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SessionMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SessionPeer::SESS_ID);

		$criteria->addSelectColumn(SessionPeer::SESS_DATA);

		$criteria->addSelectColumn(SessionPeer::SESS_TIME);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(SessionPeer::SESS_ID) && $criteria->keyContainsValue(SessionPeer::SESS_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SessionPeer::SESS_ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SessionPeer::SESS_ID);
			$selectCriteria->add(SessionPeer::SESS_ID, $criteria->remove(SessionPeer::SESS_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SessionPeer::SESS_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SessionPeer::SESS_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SessionPeer::DATABASE_NAME);
			$criteria->add(SessionPeer::SESS_ID, $pks, Criteria::IN);
...
//
// NOTE: This static code cannot call methods on the SessionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SessionPeer class:
//
// Propel::getDatabaseMap(SessionPeer::DATABASE_NAME)->addTableBuilder(SessionPeer::TABLE_NAME, SessionPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseSessionPeer::DATABASE_NAME)->addTableBuilder(BaseSessionPeer::TABLE_NAME, BaseSessionPeer::getMapBuilder());
