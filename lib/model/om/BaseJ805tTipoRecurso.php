...
/**
 * Base class that represents a row from the 'j805t_tipo_recurso' table.
 *
 * 
 *
 ...
 */
abstract class BaseJ805tTipoRecurso extends BaseObject  implements Persistent {


  const PEER = 'J805tTipoRecursoPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        J805tTipoRecursoPeer
	 */
	...
	/**
	 * Initializes internal state of BaseJ805tTipoRecurso object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     J805tTipoRecurso The current object (for fluent API support)
	 */
	public function setCoTipoRecurso($v)
	{
		...
		if ($this->co_tipo_recurso !== $v) {
			...
			$this->modifiedColumns[] = J805tTipoRecursoPeer::CO_TIPO_RECURSO;
		}
	...
	public function setTxDescripcion($v)
	{
		...
		if ($this->tx_descripcion !== $v) {
			...
			$this->modifiedColumns[] = J805tTipoRecursoPeer::TX_DESCRIPCION;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = J805tTipoRecursoPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = J805tTipoRecursoPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCoTransaccion($v)
	{
		...
		if ($this->co_transaccion !== $v) {
			...
			$this->modifiedColumns[] = J805tTipoRecursoPeer::CO_TRANSACCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_tipo_recurso = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			...
			return $startcol + 5; // 5 = J805tTipoRecursoPeer::NUM_COLUMNS - J805tTipoRecursoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating J805tTipoRecurso object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = J805tTipoRecursoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseJ805tTipoRecurso:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			J805tTipoRecursoPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseJ805tTipoRecurso:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseJ805tTipoRecurso:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(J805tTipoRecursoPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(J805tTipoRecursoPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseJ805tTipoRecurso:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			J805tTipoRecursoPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = J805tTipoRecursoPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setCoTipoRecurso($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += J805tTipoRecursoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = J805tTipoRecursoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = J805tTipoRecursoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = J805tTipoRecursoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getCoTipoRecurso(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setCoTipoRecurso($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(J805tTipoRecursoPeer::CO_TIPO_RECURSO)) $criteria->add(J805tTipoRecursoPeer::CO_TIPO_RECURSO, $this->co_tipo_recurso);
		if ($this->isColumnModified(J805tTipoRecursoPeer::TX_DESCRIPCION)) $criteria->add(J805tTipoRecursoPeer::TX_DESCRIPCION, $this->tx_descripcion);
		if ($this->isColumnModified(J805tTipoRecursoPeer::CREATED_AT)) $criteria->add(J805tTipoRecursoPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(J805tTipoRecursoPeer::UPDATED_AT)) $criteria->add(J805tTipoRecursoPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(J805tTipoRecursoPeer::CO_TRANSACCION)) $criteria->add(J805tTipoRecursoPeer::CO_TRANSACCION, $this->co_transaccion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(J805tTipoRecursoPeer::CO_TIPO_RECURSO, $this->co_tipo_recurso);
	...
	/**
	 * Generic method to set the primary key (co_tipo_recurso column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of J805tTipoRecurso (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCoTipoRecurso(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     J805tTipoRecurso Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     J805tTipoRecursoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new J805tTipoRecursoPeer();
		}
		return self::$peer;
	}
	...
	public function getC801tTransaccion(PropelPDO $con = null)
	{
		if ($this->aC801tTransaccion === null && (($this->co_transaccion !== "" && $this->co_transaccion !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aC801tTransaccion->addJ805tTipoRecursos($this);
			 */
		}
	 ...
	 * Otherwise if this J805tTipoRecurso has previously been saved, it will retrieve
	 * related C003tActaAccs from storage. If this J805tTipoRecurso is new, it will return
		...
		if ($this->collC003tActaAccs === null) {
			if ($this->isNew()) {
			   $this->collC003tActaAccs = array();
				...
				$criteria->add(C003tActaAccPeer::CO_TIPO_RECURSO, $this->co_tipo_recurso);
	 ...
	 * Otherwise if this J805tTipoRecurso is new, it will return
	 * an empty collection; or if this J805tTipoRecurso has previously
	 * been saved, it will retrieve related C003tActaAccs from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in J805tTipoRecurso.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J805tTipoRecurso has previously been saved, it will retrieve
	 * related C004tActaAies from storage. If this J805tTipoRecurso is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collC004tActaAies === null) {
			if ($this->isNew()) {
			   $this->collC004tActaAies = array();
				...
				$criteria->add(C004tActaAiePeer::CO_RECURSO, $this->co_tipo_recurso);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseJ805tTipoRecurso:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseJ805tTipoRecurso::%s', $method));
    }
