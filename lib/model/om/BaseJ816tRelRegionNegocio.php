...
/**
 * Base class that represents a row from the 'j816t_rel_region_negocio' table.
 *
 * 
 *
 ...
 */
abstract class BaseJ816tRelRegionNegocio extends BaseObject  implements Persistent {


  const PEER = 'J816tRelRegionNegocioPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        J816tRelRegionNegocioPeer
	 */
	...
	/**
	 * Initializes internal state of BaseJ816tRelRegionNegocio object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     J816tRelRegionNegocio The current object (for fluent API support)
	 */
	public function setCoRelacion($v)
	{
		...
		if ($this->co_relacion !== $v) {
			$this->co_relacion = $v;
			$this->modifiedColumns[] = J816tRelRegionNegocioPeer::CO_RELACION;
		}
	...
	public function setCoRegion($v)
	{
		...
		if ($this->co_region !== $v) {
			$this->co_region = $v;
			$this->modifiedColumns[] = J816tRelRegionNegocioPeer::CO_REGION;
		}
	...
	public function setCoNegocio($v)
	{
		...
		if ($this->co_negocio !== $v) {
			$this->co_negocio = $v;
			$this->modifiedColumns[] = J816tRelRegionNegocioPeer::CO_NEGOCIO;
		}
	...
	public function setCoDivision($v)
	{
		...
		if ($this->co_division !== $v) {
			$this->co_division = $v;
			$this->modifiedColumns[] = J816tRelRegionNegocioPeer::CO_DIVISION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = J816tRelRegionNegocioPeer::NUM_COLUMNS - J816tRelRegionNegocioPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating J816tRelRegionNegocio object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = J816tRelRegionNegocioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseJ816tRelRegionNegocio:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			J816tRelRegionNegocioPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseJ816tRelRegionNegocio:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseJ816tRelRegionNegocio:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseJ816tRelRegionNegocio:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			J816tRelRegionNegocioPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = J816tRelRegionNegocioPeer::doInsert($this, $con);
					...
					$affectedRows += J816tRelRegionNegocioPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = J816tRelRegionNegocioPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = J816tRelRegionNegocioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = J816tRelRegionNegocioPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(J816tRelRegionNegocioPeer::CO_RELACION)) $criteria->add(J816tRelRegionNegocioPeer::CO_RELACION, $this->co_relacion);
		if ($this->isColumnModified(J816tRelRegionNegocioPeer::CO_REGION)) $criteria->add(J816tRelRegionNegocioPeer::CO_REGION, $this->co_region);
		if ($this->isColumnModified(J816tRelRegionNegocioPeer::CO_NEGOCIO)) $criteria->add(J816tRelRegionNegocioPeer::CO_NEGOCIO, $this->co_negocio);
		if ($this->isColumnModified(J816tRelRegionNegocioPeer::CO_DIVISION)) $criteria->add(J816tRelRegionNegocioPeer::CO_DIVISION, $this->co_division);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(J816tRelRegionNegocioPeer::CO_RELACION, $this->co_relacion);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of J816tRelRegionNegocio (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     J816tRelRegionNegocio Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     J816tRelRegionNegocioPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new J816tRelRegionNegocioPeer();
		}
		return self::$peer;
	}
	...
	public function setJ813tRegion(J813tRegion $v = null)
	{
		...
		if ($v !== null) {
			$v->addJ816tRelRegionNegocio($this);
		}
	...
	public function getJ813tRegion(PropelPDO $con = null)
	{
		if ($this->aJ813tRegion === null && (($this->co_region !== "" && $this->co_region !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aJ813tRegion->addJ816tRelRegionNegocios($this);
			 */
		}
	...
	public function getJ814tNegocio(PropelPDO $con = null)
	{
		if ($this->aJ814tNegocio === null && (($this->co_negocio !== "" && $this->co_negocio !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aJ814tNegocio->addJ816tRelRegionNegocios($this);
			 */
		}
	...
	public function getJ815tDivision(PropelPDO $con = null)
	{
		if ($this->aJ815tDivision === null && (($this->co_division !== "" && $this->co_division !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aJ815tDivision->addJ816tRelRegionNegocios($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseJ816tRelRegionNegocio:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseJ816tRelRegionNegocio::%s', $method));
    }
