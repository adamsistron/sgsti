...
class J811tUsuarioActions extends autoJ811tUsuarioActions
{
...
//		    "msg" =>  $e->getMessage()
  ...
  public function executeStorelista(sfWebRequest $request)
  {
    ...
    $c = new Criteria();
    //Limpiamos columnas seleccionadas por defecto
    $c->clearSelectColumns();
    //Seleccionamos columnas para el resultado del Query
    $c->addSelectColumn(J811tUsuarioPeer::CO_USUARIO);
    $c->addSelectColumn(J811tUsuarioPeer::TX_INDICADOR);
    $c->addSelectColumn(J811tUsuarioPeer::CO_ROL);
    $c->addSelectColumn(J811tUsuarioPeer::CO_PERSONA);
    $c->addSelectColumn(J809tRolPeer::TX_ROL);
    //$c->addSelectColumn(J812PersonaPeer::NB_PERSONA);
    //Join con tablas relacionadas para traer el texto descriptivo según el código
    $c->addJoin(J811tUsuarioPeer::CO_ROL, J809tRolPeer::CO_ROL);
    //$c->addJoin(J811tUsuarioPeer::CO_PERSONA, J812PersonaPeer::CO_PERSONA);
    ...
    $registros[] = array(
            ...
            //"tx_persona"     => trim($res["tx_persona"]),
